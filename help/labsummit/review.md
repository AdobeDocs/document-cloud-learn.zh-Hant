---
title: 共用PDF檔案並線上檢閱
description: 瞭解使用Adobe Document Cloud的一些技巧和秘訣
...
![步驟1影像](assets/Step1.png)

**步驟2：**&#x200B;按一下右側面板中的&#x200B;**[!UICONTROL 傳送註解]**，或右上角的&#x200B;**[!UICONTROL 與其他人共用此檔案]** ![註解圖示](assets/sendforcommentsicon.png)圖示。

**步驟3：**&#x200B;輸入收件者的電子郵件地址。 您可以輸入訊息給收件者，或新增稽核的截止日期。

![步驟2C影像](assets/Step2C.png)

收件者檢視您的檔案後，您將會收到電子郵件通知。

![傳遞回條影像](assets/deliveryReceipt_Track.png)
...
**步驟2：**&#x200B;按一下&#x200B;**[!UICONTROL 共用連結]** ![連結圖示](assets/sendlinkicon.png)。 系統會立即產生共用連結，因此您不必等候檔案上傳至雲端。 依預設，[!UICONTROL 允許註解]開關是開啟的。

![步驟2L影像](assets/Step2L.png)
...
![按一下註解](assets/Cselect.jpg)

**步驟2：**&#x200B;使用頂端功能區工具來標示檔案和/或輸入註解。

![註解ui](assets/commentsui.png)
...
在Indd中有![個PDF註解](assets/inddpdf.png)

**步驟4：**&#x200B;從下拉式清單中按一下&#x200B;**[!UICONTROL 匯入PDF註解]**。

**步驟5：**&#x200B;開啟包含註解的PDF。

在Indd中有![個PDF註解](assets/inddpdfshown.png)

...
+ 進階工作 {#advanced-tasks}
   ...
   + 發送 {#advanced-tasks-sending}
      ...
      + [Acrobat簽署文字標記](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/advanced-tasks-admins/adobe-sign-text-tagging.html?lang=zh-Hant)
...
+ 管理 {#admin-set-up}
   ...
   + 開始 {#getting-started-admin}
      ...
      + [報告和交易使用方式](https://experienceleague.adobe.com/zh-hant/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)

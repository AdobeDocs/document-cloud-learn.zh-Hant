---
title: 從 [!DNL Intesi Group] 取得數位識別碼（合格）
description: 瞭解如何從 [!DNL Intesi Group]取得合格的數位簽署憑證
feature: Digital ID
role: User
level: Beginner
jira: KT-8704
...
**選取下列影像以瞭解如何在Acrobat Sign中使用您合格的[!DNL Intesi Group]數位ID。**

---
title: Acrobat Sign文字標籤
description: 瞭解如何透過文字標籤建立Acrobat Sign表單欄位
...
1. 從&#x200B;**[!UICONTROL 選項]**&#x200B;面板下拉式清單中選取&#x200B;**[!UICONTROL 準備表單以進行電子簽署]**。
   ...
   ![準備表單以進行電子簽署](../assets/tag-prepare-e-signing.png)

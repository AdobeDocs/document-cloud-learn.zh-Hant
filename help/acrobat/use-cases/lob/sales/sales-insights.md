---
title: 將客戶情報變成成功的銷售Assets
description: 瞭解銷售團隊如何收集客戶深入分析、共同作業，並產生品牌內簡報
feature: Gen AI
role: User
level: Intermediate
jira: KT-20546
...
瞭解銷售團隊如何收集客戶見解並在共用工作區中進行共同作業，以及如何以更快的速度和更高的信心將經過驗證的情報轉換為品牌簡報和提案。 此使用案例旨在依序完成，每個影片都建立在上一步中。

**最適合：**&#x200B;客戶高階主管、銷售經理、交易團隊，以及任何準備會議、簡報或提案的面對客戶銷售資料的人。


**試用：**&#x200B;立即探索此銷售工作流程[實作](https://w.adobedemo.com/s/HEEljN){target="_blank"}。

## 步驟 1. 透過AI支援的深入分析瞭解您的客戶

...
+ 由AI支援 {#ai-powered}
  ...
  + [什麼是Acrobat Studio？](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/get-started/basics/acrobat-studio)
...
+ 使用案例 {#use-cases}
  ...
  + 業務線 {#lob}
    + 財務 {#finance}
      ...
      + [從insight準備執行就緒的財務檔案以進行傳送](use-cases/lob/finance/finance-insights.md)
    + 人力資源 {#hr}
    ...
    + 銷售 {#sales}
      ...
      + [將客戶情報轉化為成功的銷售資產](use-cases/lob/sales/sales-insights.md)
  + 政府 {#gov}
    ...
    + 使用Acrobat時隨處使用的5個秘訣 {#tips}
      ...
      + [提示#4 — 使用表單和簽名](use-cases/gov/work-with-forms-and-signatures.md)
      + [提示#5 — 在行動裝置上掃描和編輯](use-cases/gov/scan-and-edit-on-mobile.md)

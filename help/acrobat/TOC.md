...
+ 開始使用 {#get-started}
   ...
   + 了解基本功能 {#basics}
      ...
      + [新Acrobat經驗](getting-started/new-experience.md)
   ...
   + 建立和組織 {#create}
      ...
      + [紙到PDF](getting-started/scan-and-ocr.md)
   + 編輯和增強 {#edit}
...
+ 行動裝置版本 {#mobile}
   ...
   + [移動中的生產力](https://experienceleague.adobe.com/zh-hant/docs/document-cloud-learn/acrobat-learning/get-started/basics/productivity)
